...
import evacuator from "@/assets/evacuator.jpg";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Аренда спецтехники в Екатеринбурге — эвакуатор, манипулятор, самосвал, мини-экскаватор" },
      { name: "description", content: "Аренда эвакуатора, манипулятора, самосвала и мини-экскаватора в Екатеринбурге и области. Цены от 2000 ₽/час. Работаем 10 лет, выезд 24/7." },
      { property: "og:title", content: "Аренда спецтехники в Екатеринбурге" },
      { property: "og:description", content: "Эвакуатор, манипулятор, самосвал, мини-экскаватор. Цены от 2000 ₽/час. Выезд 24/7." },
    ],
  }),
  component: Index,
});
